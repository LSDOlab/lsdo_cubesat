...
class TelescopeConfiguration(Model):
    ...
    def define(self):
        ...
        telescope_vector = (optics_orbit_state[:, :3] -
                            detector_orbit_state[:, :3]) * 1000
        ...
        self.add_constraint('max_separation_m', upper=500.)
        ...
        max_separation_during_observation = csdl.max(
            separation_during_observation)
        min_separation_during_observation = csdl.max(
            observation_phase_indicator * (telescope_length_m - separation_m))
        ...
        cos_view_angle = telescope_vector_component_in_sun_direction / separation_m
        ...
        max_telescope_view_angle = csdl.max(telescope_view_angle, rho=20)
        self.register_output(
