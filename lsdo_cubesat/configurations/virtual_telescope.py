...
from lsdo_cubesat.specifications.virtual_telescope import VirtualTelescopeSpec
from lsdo_cubesat.disciplines.virtual_telescope.observation_phase import ObservationPhase
from lsdo_cubesat.disciplines.virtual_telescope.alignment import Alignment
from lsdo_cubesat.disciplines.virtual_telescope.separation import Separation
from lsdo_cubesat.disciplines.virtual_telescope.spacecraft_pointing import SpacecraftPointing
from lsdo_cubesat.disciplines.virtual_telescope.telescope_pointing import TelescopePointing
...
class VirtualTelescope(Model):
    ...
    def define(self):
        swarm: SwarmSpec = self.parameters['swarm']
        num_times: int = swarm['num_times']
        num_cp: int = swarm['num_cp']
        step_size: float = swarm['step_size']
        duration: float = swarm['duration']
