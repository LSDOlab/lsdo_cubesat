...
from lsdo_cubesat.eps.battery.battery_cell import BatteryCell
...
class BatteryPack(Model):
    ...
    def define(self):
        ...
        self.register_output('open_circuit_voltage', double_open_circuit_voltage/2)
        self.register_output('internal_resistance', double_internal_resistance/2)
        self.register_output('polarization_resistance', double_polarization_resistance/2)
        self.register_output('equivalent_capacitance', double_equivalent_capacitance/2)

if __name__ == '__main__':
    from csdl import GraphRepresentation

    rep = GraphRepresentation(BatteryPack(num_times=10))
    # rep.visualize_graph(draw_implicit=True)
    # rep.visualize_graph()
