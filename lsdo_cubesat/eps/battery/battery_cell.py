...
from lsdo_cubesat.eps.battery.equivalent_circuit.li_ion import LiIon
from lsdo_cubesat.eps.battery.equivalent_circuit.soc import SOC_Integrator
from lsdo_cubesat.eps.battery.equivalent_circuit.thevenin import TheveninVoltageIntegrator
...
class BatteryCell(Model):
    ...
    def define(self):
        ...
        temperature = self.declare_variable('temperature', shape=(num_times, 1 ))
