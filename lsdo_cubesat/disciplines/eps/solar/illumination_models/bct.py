...
# load training data
from lsdo_cubesat.disciplines.eps.solar.illumination_models.data.cubesat_xdata import cubesat_xdata as az
from lsdo_cubesat.disciplines.eps.solar.illumination_models.data.cubesat_ydata import cubesat_ydata as el
from lsdo_cubesat.disciplines.eps.solar.illumination_models.data.cubesat_zdata import cubesat_zdata as yt
