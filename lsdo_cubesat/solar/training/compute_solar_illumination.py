...
def compute_solar_illumination(
    ...
    for i in range(TOTAL_NUM_POLYGONS):
        ...
        if solar_panel == True:
            ...
            face_normal = face_normals[i, :]  # panel normals
...
filename = "CubeTestIn.STL"
# Loads STL file that will be triangulated.
...
tetgen.max_tet_volume = 1
tetgen.verbosity = 0
tetgen.run()
# pymesh.save_mesh("CubeTestOut.stl", mesh)

a = compute_solar_illumination(
    azimuth,
    elevation,
    mesh.faces_area,
)
