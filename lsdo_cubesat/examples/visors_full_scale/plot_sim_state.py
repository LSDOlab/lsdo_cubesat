...
def plot_sim_state(sim):
    ...
    # plt.title('thrust profile (ctrl pts)')
    # plt.plot(sim['optics_cubesat.thrust_mN_cp'][0, :])
    # plt.plot(sim['optics_cubesat.thrust_mN_cp'][1, :])
    # plt.plot(sim['optics_cubesat.thrust_mN_cp'][2, :])
    # plt.plot(sim['detector_cubesat.thrust_mN_cp'][0, :])
    # plt.plot(sim['detector_cubesat.thrust_mN_cp'][1, :])
    # plt.plot(sim['detector_cubesat.thrust_mN_cp'][2, :])
    # plt.show()
    ...
    # plt.title('thrust unit vector magnitude')
    # plt.plot(sim['optics_cubesat.thrust_unit_vector_cp_mag'])
    # plt.plot(sim['detector_cubesat.thrust_unit_vector_cp_mag'])
    # plt.show()
