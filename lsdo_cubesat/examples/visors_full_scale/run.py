...
from lsdo_cubesat.examples.visors_utils.warm_start import warm_start
from lsdo_cubesat.examples.visors_full_scale.make_swarm import make_swarm
...
# options.setOption('Major iterations', maxiter)
...
if True:
    ...
    sim.run()
    if print_vars is True:
        print('optics_cubesat.pitch', sim['optics_cubesat.pitch'])
        print('optics_cubesat.rw_torque', sim['optics_cubesat.rw_torque'])
        print('optics_cubesat.rw_torque_min',
              sim['optics_cubesat.rw_torque_min'])
        print('optics_cubesat.rw_torque_max',
              sim['optics_cubesat.rw_torque_max'])
        print('optics_cubesat.rw_speed', sim['optics_cubesat.rw_speed'])
        print('optics_cubesat.rw_speed_min',
              sim['optics_cubesat.rw_speed_min'])
        print('optics_cubesat.rw_speed_max',
              sim['optics_cubesat.rw_speed_max'])
        ...
        print('detector_cubesat.max_current',
              sim['detector_cubesat.max_current'])
        print('detector_cubesat.min_current',
              sim['detector_cubesat.min_current'])
