...
class StationPositionComp(ExplicitComponent):
    """
...
if __name__ == '__main__':
    ...
    comp = IndepVarComp()
    num_times = 3
    comp.add_output('lon', val= 20)
    comp.add_output('lat', val= 20)
    comp.add_output('alt', val= 100)

    group.add_subsystem('Inputcomp', comp, promotes=['*'])
    group.add_subsystem('station_position',
                        StationPositionComp(num_times=num_times),
                        promotes=['*'])
