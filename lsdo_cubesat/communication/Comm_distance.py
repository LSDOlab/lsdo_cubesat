...
class StationSatelliteDistanceComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('distance_to_groundstation', 'r_b2g_A')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['distance_to_groundstation'] = np.linalg.norm(r_b2g_A, axis=0)
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials['distance_to_groundstation', 'r_b2g_A'] = dGS_drot.flatten()
