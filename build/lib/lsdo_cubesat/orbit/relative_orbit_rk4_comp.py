...
class RelativeOrbitRK4Comp(RK4Comp):
    ...
    def setup(self):
        ...
        self.add_input('force_3xn',
                       shape=(3, n),
                       desc='Thrust on the cubesat')
    ...
    def df_dx(self, external, state):
        ...
        dfdx[3, 3] = -external[0] / external[3]**2 + drag * state[3] / external[3]**2
        dfdx[4, 3] = -external[1] / external[3]**2 + drag * state[4] / external[3]**2
        dfdx[5, 3] = -external[2] / external[3]**2 + drag * state[5] / external[3]**2
